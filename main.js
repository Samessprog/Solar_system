...
if (displayedWindow) {
  let closePlanetDescIcon = document.getElementById('closeIcon');
  closePlanetDescIcon.addEventListener('click', function () {
...
let handlePlanetSpeedSlider = document.getElementById('planetSpeedSlider');
handlePlanetSpeedSlider.addEventListener('click', () => {
  movable = true;
});
...
let handleFollowPlanetButton = document.getElementById('followPlanetButton');
handleFollowPlanetButton.addEventListener('click', () => {
  follow = !follow;
});
